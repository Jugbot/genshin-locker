import { ArgumentsCamelCase, InferredOptionTypes, Options, CommandModule } from "yargs";
...
export const asCommand = <T extends OptionsDict>(module: MyCommandModule<T>): CommandModule<{/*_*/}, InferredOptionTypes<T>> => module